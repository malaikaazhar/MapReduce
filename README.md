...
Now we are performing the lower() method to make all text lower and lemmatization to map to root words after that we have the final result like this.
...
Here we are checking i how many documents each unique word is occuring: mapper.py reducer.py
